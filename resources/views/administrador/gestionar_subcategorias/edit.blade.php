                ...
                <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
                    <div class="d-table-cell align-middle">
                        <div class="text-center mt-4">
                            <h1 class="h2">Modificar Subcategoria</h1>
                            <p class="lead">
                                    ...
                                    <form action="{{ route('subcategorias.update', $subcategoria->id) }}" method="POST"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control form-control-lg" type="text" name="nombre"
                                                value="{{ $subcategoria->nombre }}" placeholder="Ingrese el nombre del producto" />
                                            @error('nombre')
                                            ...
                                            <select name="categoria_id" class="form-control">
                                                @foreach ($categorias as $categoria)
                                                    <option value="{{ $categoria->id }}"
                                                        @if ($categoria->id == $subcategoria->categoria_id) selected @endif>
                                                        {{ $categoria->nombre }}
                                                    </option>
                                                @endforeach
